...
class OperacionController extends Controller
{
    ...
    public function show($id)
    {
        try {
            ...
            // ==============================================================================
            $lineasDisponibles = CarSiaLinea::all();
            ...
            // 3. ENVIAR LAS VARIABLES AL COMPACT (AGREGAMOS $lineasDisponibles AQUÍ)
            return view('certificados.operaciones.show', compact(
                ...
                'distritos', 'maeTipos', 'congregaciones','tiposCertificados','tiposGestion', 'operacionesDelTercero', 'certificadosGlobalesTercero', 'soportes', 'interacciones', 'documentosAsociado', 'lineasDisponibles','usuarios'
            ));
    ...
    // =========================================================================
        ...
        public function generarMasivo(Request $request)
        {
            ...
            if (empty($tipos_seleccionados) || !is_array($tipos_seleccionados)) {
                return back()->with('error', 'Debe seleccionar al menos un tipo de certificado.');
            }
                        ...
                        foreach ($facturasChunk as $factura) {
                            ...
                            if (count($reglas) > 0) {
                                ...
                                $metadataRegla = json_encode([
                                    ...
                                    "clasificacion_mora" => strtolower($calificacion), "notificacion_gerencia" => false,
