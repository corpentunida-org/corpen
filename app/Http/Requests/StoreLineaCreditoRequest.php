...
class StoreLineaCreditoRequest extends FormRequest
{
    ...
    {
        return [
            'nombre' => 'required|string|max:255|unique:cre_lineas_creditos,nombre',
            'cuenta' => 'required|integer',
            'tasa_interes' => 'required|numeric|min:0|max:100',
            'plazo_minimo' => 'required|integer|min:1',
            'plazo_maximo' => 'required|integer|min:1|gte:plazo_minimo', // gte = greater than or equal
