        ...
        <div class="subscription-plan px-4 pt-4">
            ...
            <div
                ...
                <div class="my-3 my-xxl-0 my-md-3 my-md-0">
                    <div class="fs-20 text-dark"><span class="fw-bold">${{$poliza->valor_prima}}</span> / <em
                            class="fs-11 fw-medium">Mes</em></div>
                    <div class="fs-12 text-muted mt-1"><strong
                            class="text-dark">EXTRA: </strong>{{$poliza->extra_prima}}%</div>
                </div>
            ...
            <div class="row">
                <div class="col-xxl-4 col-xl-12 col-lg-4">
                    <a href="javascript:void(0);"
                        ...
                        <p class="fs-12 fw-normal text-muted text-truncate-2-line">Lorem, ipsum dolor sit amet
                            consectetur adipisicing elit. Quod ipsa id corrupti modi, impedit exercitationem harum
                            voluptates reiciendis.</p>
                        <div class="mt-4"><span class="fs-16 fw-bold text-dark">$12.99</span> / <em
                ...
                <div class="col-xxl-4 col-xl-12 col-lg-4">
                    <a href="javascript:void(0);"
                        ...
                        <p class="fs-12 fw-normal text-muted text-truncate-2-line">Lorem, ipsum dolor sit amet
                            consectetur adipisicing elit. Quod ipsa id corrupti modi, impedit exercitationem harum
                            voluptates reiciendis.</p>
                        <div class="mt-4"><span class="fs-16 fw-bold text-dark">$29.99</span> / <em
                                class="fs-11 fw-medium">Month</em></div>
                        <div class="position-absolute top-0 start-50 translate-middle">
                            <i class="feather-check fs-12 bg-primary text-white p-1 rounded-circle"></i>
                        </div>
                ...
                <div class="col-xxl-4 col-xl-12 col-lg-4">
                    <a href="javascript:void(0);"
                        ...
                        <p class="fs-12 fw-normal text-muted text-truncate-2-line">Lorem, ipsum dolor sit amet
                            consectetur adipisicing elit. Quod ipsa id corrupti modi, impedit exercitationem harum
                            voluptates reiciendis.</p>
                        <div class="mt-4"><span class="fs-16 fw-bold text-dark">$49.99</span> / <em
                                class="fs-11 fw-medium">Month</em></div>
                    </a>
                </div>
            </div>
                        ...
                        @foreach ($grupoFamiliar as $familiar)
                            @if ($familiar->cedula != $poliza->seg_asegurado_id)
                                <tr>
                                    ...
                                    <td>{{ $familiar->tercero->nombre }}</td>
                                    <td>{{ $familiar->parentesco }}</td>
                                    <td><span class="badge bg-soft-warning text-warning">Plan</span></td>
                                    <td class="hstack justify-content-end gap-4 text-end">
                                        <a data-bs-toggle="tooltip" data-bs-trigger="hover"
                                            data-bs-original-title="Ver Poliza">
                                            <i class="feather feather-send fs-12"></i>
