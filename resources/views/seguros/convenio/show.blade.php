        ...
        <div class="card stretch stretch-full">
            <div class="card-body task-header d-lg-flex align-items-center justify-content-between">
                <div class="mb-4 mb-lg-0">
                    ...
                    <div class="fs-4 fw-bold text-dark"><span class="counter">{{ $convenio->nombre }}</span>
                        @if ($convenio->vigente)
                ...
                <div class="d-flex gap-2">
                    ...
                    <a href="{{ route('seguros.planes.create', ['convenio_id' => $convenio->idConvenio]) }}"
                        class="btn btn-success" data-bs-toggle="tooltip" title=""
                        data-bs-original-title="{{ $convenio->nombre }}">
                            ...
                            <div class="col-xxl-2 col-lg-4 col-md-6">
                                <div class="card stretch stretch-full border border-dashed border-gray-5">
                                    <div class="card-header">
                                        <h5 class="card-title mb-0">#{{ $plan->id }}</h5>
                                    ...
                                    <div class="card-body rounded-3">
                                        <div class="text-center">
                                            ...
                                            <p class="fs-12 fw-medium text-muted mb-0">
                                                <span class="fw-semibold text-dark">Prima Aseguradora:</span>
                                                ${{ number_format($plan->prima_aseguradora) }}
                                            </p>
                                            <p class="fs-12 fw-medium text-muted mb-0">
                                                <span class="fw-semibold text-dark">Aseguradora pastor:</span>
                                                ${{ number_format($plan->prima_aseguradoraAF) }}
                                            </p>

                                            <p class="fs-12 fw-medium text-muted mb-0">
                                                <span class="fw-semibold text-dark">Corpen Asegurado:</span>
