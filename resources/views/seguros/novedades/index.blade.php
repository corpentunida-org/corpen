                                ...
                                @can('seguros.poliza.update')
                                    <td class="text-end">
                                        <div class="hstack gap-2 justify-content-end">
                                            <a href="{{ route('seguros.novedades.create', ['a' => $reg->cedula]) }}" class="avatar-text avatar-md" data-bs-toggle="tooltip" title="" data-bs-original-title="Crear Novedad">
