            ...
            <div class="tab-content">
                <div class="tab-pane fade p-4 active show" id="securityTab" role="tabpanel">
                    <div class="col-lg-12">
                        <div class="card stretch stretch-full">
                            <div class="card-body">
                                <form method="POST" action="{{ route('exequial.beneficiarios.update', $id) }}"
                                    id="formUpdateBeneficiario" novalidate>
                                    @csrf
                                    @method('PUT')
                                    <div class="mb-4">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <input type="text" class="form-control" value="{{ $beneficiario['name'] }}"
                                            name="names" required>
                                    </div>
                                    <div class="mb-4">
                                        ...
                                        <select class="form-control" name="parentesco" id="parentesco" required>
                                            @foreach ($parentescos as $par)
                                                <option value="{{ $par['code'] }}"
                                                    {{ $par['name'] == $beneficiario['relationship'] ? 'selected' : '' }}>
                                                    {{ $par['name'] }}
                                                </option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <input type="date" class="form-control"
                                            value="{{ $beneficiario['dateBirthday'] }}" name="fechaNacimiento"
                                            required>
                                    </div>
