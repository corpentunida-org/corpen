...
<div class="mb-4 d-flex align-items-center justify-content-between">
    ...
    <div class="d-flex gap-2">
        @if ($asociado['stade'])
            @candirect('exequial.beneficiarios.store')
                                        ...
                                        <div class="dropdown">
                                            ...
                                            @if ($asociado['stade'])
                                                <ul class="dropdown-menu">
                                                    @candirect('exequial.beneficiarios.update')
                                                    <li>
                                                        <form
                                                    ...
                                                    @endcandirect
                                                    @candirect('exequial.beneficiarios.destroy')
                                                    <li class="dropdown-divider"></li>
                                                    <li>
                                                        <form
...
<div class="offcanvas offcanvas-end modal-dialog-scrollable" tabindex="-1" id="proposalSent">
    ...
    <form method="POST" action="{{ route('exequial.prestarServicio.store') }}" id="FormularioPrestarServicio"
        ...
        <div class="px-4 gap-2 d-flex align-items-center ht-80 border border-end-0 border-gray-2">
            <a class="btn btn-danger w-50" data-bs-dismiss="offcanvas">Cancel</a>
