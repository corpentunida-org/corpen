        ...
        <div class="col-md-3">
            <form id="formFiltroMes">
                <select name="months" class="form-select" id="selectMes">
                    ...
                    <option value="9">Sepriembre</option>
        ...
        <table class="table">
            ...
            @foreach ($registros as $reg)
                        <tr>
                            ...
                            <td>{{ $reg->valor }}</td>
                            <td>
                                <a class="btn btn-warning ml-1 py-2 btn-detallePrestarServicio" data-index={{ $loop->index }}
                                    data-bs-toggle="modal" data-bs-target="#ModalFormServicio">
...
<!-- MODAL SERVICIOS -->
<div class="modal fade" id="ModalFormServicio" tabindex="-1" aria-labelledby="ModalFormServicio" aria-hidden="true"
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-5 pr-1">
                            <div class="form-group">
                                ...
                                <input type="text" id="lugarFallecimiento" class="form-control uppercase-input"
                                    name="lugarFallecimiento" required>
                            </div>
                        </div>
                        <div class="col-md-3 px-1">
                            <div class="form-group">
                                <label>Fecha <span class="required-asterisk">*</span></label>
                                <input type="date" id="fechaFallecimiento" class="form-control"
                        ...
                        <div class="col-md-4 pl-1">
                            <div class="form-group">
                                ...
                                <input type="time" id="horaFallecimiento" class="form-control" name="horaFallecimiento"
                                    required>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6 pr-1">
                            <div class="form-group">
                                ...
                                <input type="text" id="contacto" class="form-control uppercase-input" name="contacto"
                                    required>
                            </div>
                        </div>
                        <div class="col-md-6 pl-1">
                            <div class="form-group">
                                ...
                                <input type="text" id="telcontacto" class="form-control" name="telefonoContacto"
                                    required>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6 pr-1">
                            <div class="form-group">
                                ...
                                <input type="text" id="contactodos" class="form-control uppercase-input"
                                    name="contacto2">
                            </div>
                        </div>
                        <div class="col-md-6 pl-1">
...
<div class="modal fade" id="modalConfirmarEliminacion" data-bs-backdrop="static" tabindex="-1"
...
<div class="modal fade mt-auto" id="modalConfirmarUpdate" data-bs-backdrop="static" tabindex="-1"
    aria-labelledby="ConfirmarEnvioUpdate" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            ...
            <div class="modal-footer">
                ...
                <button type="button" id="btnNOEnvio" class="btn btn-secondary" data-bs-dismiss="modal"
