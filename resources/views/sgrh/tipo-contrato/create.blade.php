<x-base-layout>
    ...
    <div class="row mb-4 align-items-end">
        <div class="col-md-8">
            <h2 class="fw-bold text-dark mb-1">Registrar tipo de contrato</h2>
        </div>
    ...
    <div class="card">
        <div class="card-body p-4">
            ...
            <form method="POST" action="{{ route('sgrh.tipo-contrato.store') }}" id="formRegistrarTipoContrato">
                @csrf
                @include('sgrh.tipo-contrato._form', ['tipoContrato' => null])
    ...
    @push('scripts')
        <script>
            ...
            (function () {
                const form = document.getElementById('formRegistrarTipoContrato');
