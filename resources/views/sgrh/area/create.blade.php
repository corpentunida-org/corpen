<x-base-layout>
    ...
    <div class="row mb-4 align-items-end">
        <div class="col-md-8">
            <h2 class="fw-bold text-dark mb-1">Registrar área</h2>
            <p class="text-muted mb-0">Crea un área de la estructura organizacional de RR. HH.</p>
        </div>
    ...
    <div class="card">
        <div class="card-body p-4">
            ...
            <form method="POST" action="{{ route('sgrh.area.store') }}" id="formRegistrarArea">
                @csrf
                @include('sgrh.area._form', ['area' => null, 'cargos' => $cargos])
