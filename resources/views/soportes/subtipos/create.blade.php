<x-base-layout>
    @section('titlepage', 'Crear Sub-Tipo de Soporte')
            ...
            <div class="card-body task-header d-lg-flex align-items-center justify-content-between">
                <div class="mb-4 mb-lg-0">
                    <div class="d-flex gap-4 align-items-center">
                        ...
                        <div>
                            <div class="fs-4 fw-bold text-dark">Crear Sub-Tipo de Soporte</div>
                            <h3 class="fs-13 fw-semibold text-truncate-1-line">
                                Establece un nuevo sub-tipo para los soportes.
                            </h3>
                        </div>
                    </div>
                </div>
        ...
        <div class="card border-top-0">
            ...
            <div class="tab-content">
                <div class="tab-pane fade p-4 active show" id="infoTab" role="tabpanel">
                    ...
                    <form method="POST" action="{{ route('soportes.subtipos.store') }}">
                        @csrf
                        @include('soportes.subtipos.form')
                        <div class="d-flex flex-row-reverse gap-2 mt-4">
                            <button class="btn btn-success" type="submit">
                                <i class="feather-plus me-2"></i> Crear Sub-Tipo
                            </button>
