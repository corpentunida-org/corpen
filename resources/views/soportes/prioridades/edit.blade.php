<x-base-layout>
    @section('titlepage', 'Editar Prioridad')
            ...
            <div class="card-body task-header d-lg-flex align-items-center justify-content-between">
                <div class="mb-4 mb-lg-0">
                    <div class="d-flex gap-4 align-items-center">
                        ...
                        <div>
                            <div class="fs-4 fw-bold text-dark">Editar Prioridad</div>
    ...
    <div class="col-xxl-12 col-xl-12 mt-3">
        <div class="card border-top-0">
            <div class="card-body p-4">
                <form method="POST" action="{{ route('soportes.prioridades.update', $scpPrioridad) }}">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control @error('nombre') is-invalid @enderror"
                                id="nombre" name="nombre" value="{{ old('nombre', $scpPrioridad->nombre) }}" required>
                            @error('nombre')
