<x-base-layout>
    @section('titlepage', 'Crear Nueva Prioridad')
                ...
                <div class="mb-4 mb-lg-0">
                    <div class="d-flex gap-4 align-items-center">
                        <div class="avatar-text avatar-lg bg-warning text-white">
                            <i class="bi bi-exclamation-triangle"></i> {{-- Icono para Prioridades --}}
                        </div>
                        <div>
                            ...
                            <h3 class="fs-13 fw-semibold text-truncate-1-line">
                                Establece un nuevo nivel de prioridad para tus soportes.
                            </h3>
                        </div>
                    </div>
                </div>
        ...
        <div class="card border-top-0">
            ...
            <div class="tab-content">
                <div class="tab-pane fade p-4 active show" id="infoTab" role="tabpanel">
                    ...
                    <form method="POST" action="{{ route('soportes.prioridades.store') }}">
                        @csrf
                        ...
                        <div class="d-flex flex-row-reverse gap-2 mt-4">
                            <button class="btn btn-success" type="submit">
                                <i class="feather-plus me-2"></i> Crear Prioridad
                            </button>
