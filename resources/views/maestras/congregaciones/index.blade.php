                                ...
                                <td class="hstack justify-content-end gap-4 text-end py-1 px-2">
                                    <div class="dropdown open">
                                        ...
                                        <ul class="dropdown-menu">
                                            <li>
                                                <a class="dropdown-item btnVer"
                                                    href="{{ route('maestras.congregacion.show', $congregacion->codigo) }}">
                                                    <i class="feather feather-eye me-3"></i>
                                                    <span>Ver</span>
                                                </a>
                                            </li>
                                            <li>
                                                <a class="dropdown-item btnEditar"
                                                    href="{{ route('maestras.congregacion.edit', $congregacion->codigo) }}">
                                            ...
                                            <li>
                                                <form
                                                    action="{{ route('maestras.congregacion.destroy', $congregacion->codigo) }}"
