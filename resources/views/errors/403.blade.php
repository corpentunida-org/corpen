                    ...
                    <div class="row flex-1 g-0">
                        <div class="col-lg-6 h-100 my-auto">
                            ...
                            <div class="creative-card-body card-body p-sm-5">
                                <h2 class="fw-bolder mb-4" style="font-size: 120px">4<span class="text-warning">0</span>4</h2>
                                <h4 class="fw-bold mb-2">Página no encontrada</h4>
                                <p class="fs-12 fw-medium text-muted">Lo sentimos. La página que estas buscando no esta disponible. Por favor revisa la URL o intenta en una diferente en nuestro sitio.</p>
                                <div class="mt-5">
                                    <a href="/" class="btn btn-light-brand w-100">Volver al inicio</a>
                                </div>
                            </div>
                        </div>
