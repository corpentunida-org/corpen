<x-base-layout>
    <div class="app-container py-4">
        <header class="main-header mb-4">
            ...
            <div class="header-actions d-flex gap-2">
                @if(empty($flujo->trd))
                    <button type="button" class="btn btn-outline-brand btn-sm d-flex align-items-center rounded-3 px-3 shadow-sm bg-white" data-bs-toggle="modal" data-bs-target="#modalTRD">
                        <i class="bi bi-folder-plus me-1"></i> Configurar TRD
                    </button>
                @endif
                <button type="button" class="btn-action-primary shadow-sm" data-bs-toggle="modal" data-bs-target="#modalCrearProceso">
                    <i class="bi bi-plus-circle-fill me-1"></i> Nuevo Proceso
                </button>
        ...
        <div class="row">
            ...
            <div class="col-lg-4">
                ...
                <div class="card border-0 shadow-sm rounded-4 mb-4">
                    <div class="card-body p-4 text-center">
                        <div class="icon-box bg-soft-brand text-brand mx-auto mb-3" style="width: 70px; height: 70px; border-radius: 15px; display: flex; align-items: center; justify-content: center;">
                        ...
                        <div class="text-start">
                            <div class="mb-3">
                                ...
                                <div class="d-flex align-items-center mt-1 text-brand">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="d-flex align-items-center mt-1">
                                    <div class="avatar-xs bg-brand text-white me-2" style="width: 28px; height: 28px; border-radius: 50%; display: flex; align-items: center; justify-content: center; font-size: 11px; font-weight: bold;">
                            ...
                            <div class="mb-3 bg-light p-3 rounded-3 border">
                                ...
                                @else
                                    <div class="d-flex align-items-center justify-content-between mt-1">
                                        ...
                                        <button class="btn btn-sm btn-light border text-brand rounded-pill px-3 shadow-sm hover-up" style="font-size: 0.7rem; font-weight: bold;" data-bs-toggle="modal" data-bs-target="#modalTRD">
                                            Asignar ahora
                                        </button>
                                    </div>
                                @endif
                            ...
                            <div class="card-body p-3 d-flex align-items-center justify-content-between">
                                <div>
                                    <div class="d-flex align-items-center mb-1">
                                        <i class="bi bi-stopwatch text-brand me-2"></i>
                                ...
                                <div class="text-end">
                                    <h4 class="fw-bold text-brand mb-0">{{ number_format($tiempo_promedio_dias, 1) }}</h4>
            ...
            <div class="col-lg-8">
                ...
                {{-- DASHBOARD CUELLO DE BOTELLA (Chart.js) --}}
                <div class="card border-0 shadow-sm rounded-4 mb-4">
                    <div class="card-body p-4">
                        <div class="d-flex justify-content-between align-items-center mb-3">
                            <div>
                                <h6 class="text-uppercase fw-bold text-brand mb-0">
                    ...
                    <div class="card-body p-4">
                        <div class="d-flex justify-content-between align-items-center mb-4 pb-2 border-bottom">
                            <h6 class="text-uppercase fw-bold text-dark mb-0 d-flex align-items-center">
                                <i class="bi bi-list-check me-2 text-brand fs-5"></i>Ruta del Proceso
                            </h6>
                            <span class="badge bg-soft-brand text-brand border border-brand-subtle px-3 py-2 rounded-pill fw-bold">
                        ...
                        @forelse($flujo->procesos as $proceso)
                            <div class="d-flex mb-4 position-relative step-item {{ !$proceso->activo ? 'opacity-75' : '' }}">
                                ...
                                <div class="flex-shrink-0 me-3 mt-1">
                                    <div class="{{ $proceso->activo ? 'bg-brand text-white shadow' : 'bg-secondary text-white shadow-sm' }} rounded-circle d-flex align-items-center justify-content-center" 
                                ...
                                <div class="flex-grow-1 p-0 border rounded-4 bg-white shadow-sm hover-up overflow-hidden transition-all">
                                    <div class="p-3 {{ $proceso->activo ? 'bg-light' : 'bg-light-subtle' }} border-bottom d-flex justify-content-between align-items-center">
                                        ...
                                        <div class="btn-group shadow-sm rounded-pill">
                                            <a href="{{ route('correspondencia.procesos.show', $proceso) }}" class="btn btn-sm btn-white text-brand border" title="Configurar Equipo y Estados" style="background: white;">
                                            ...
                                            <div class="d-flex align-items-center flex-wrap gap-2">
                                                @forelse($proceso->usuarios as $user)
                                                    <span class="badge bg-white border border-secondary-subtle text-dark shadow-sm d-flex align-items-center py-1 px-2" style="font-weight: 500;">
                                                        <div class="rounded-circle text-white d-flex align-items-center justify-content-center me-1 bg-brand" 
                        ...
                        @empty
                            <div class="text-center py-5 border border-dashed rounded-4 bg-light-subtle">
                                <div class="bg-white shadow-sm rounded-circle d-inline-flex align-items-center justify-content-center mb-3" style="width: 70px; height: 70px;">
                                    <i class="bi bi-diagram-3 text-brand fs-2 opacity-75"></i>
                                </div>
                                ...
                                <button class="btn-action-primary shadow-sm" data-bs-toggle="modal" data-bs-target="#modalCrearProceso">
    ...
    <div class="modal fade" id="modalCrearProceso" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content border-0 shadow-lg rounded-4">
                <div class="modal-header bg-brand text-white rounded-top-4 border-0">
                ...
                <form action="{{ route('correspondencia.procesos.store') }}" method="POST">
                    ...
                    <div class="modal-body p-4">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group shadow-sm" style="border-radius: 8px; overflow: hidden;">
                                <span class="input-group-text bg-light border-end-0"><i class="bi bi-tag text-brand"></i></span>
                        ...
                        <div class="row g-3 mb-3">
                            <div class="col-md-6">
                                ...
                                <div class="input-group shadow-sm" style="border-radius: 8px; overflow: hidden;">
                                    <span class="input-group-text bg-light border-end-0"><i class="bi bi-clock-history text-brand"></i></span>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group shadow-sm" style="border-radius: 8px; overflow: hidden;">
                                    <span class="input-group-text bg-light border-end-0"><i class="bi bi-file-earmark-plus text-brand"></i></span>
                    ...
                    <div class="modal-footer bg-light rounded-bottom-4 border-top">
                        ...
                        <button type="submit" class="btn-action-primary btn-sm px-4 shadow-sm">
                ...
                <form action="{{ route('correspondencia.trds.store') }}" method="POST" id="form-trd">
                    ...
                    <div class="modal-body p-4">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" class="form-control bg-light border-0 fw-bold text-brand" value="{{ $flujo->nombre }}" readonly>
                    ...
                    <div class="modal-footer bg-light rounded-bottom-4 border-top">
                        ...
                        <button type="submit" id="btn-save-trd" class="btn-action-primary btn-sm px-4 shadow-sm">
    ...
    {{-- ESTILOS CORREGIDOS (Sin Púrpura, con clics táctiles) --}}
    <style>
        /* Paleta Azul Corporativo Oceánico */
        .text-brand { color: #0284c7; }
        .bg-brand { background-color: #0284c7; }
        .bg-soft-brand { background-color: #f0f9ff; }
        .border-brand-subtle { border-color: #bae6fd !important; }
        
        .bg-soft-warning { background-color: #fffbeb; }
        .bg-soft-success { background-color: #ecfdf5; }
        .border-dashed { border: 1px dashed #dee2e6; }
        
        /* Botón Principal - Arreglo del efecto al hacer clic */
        .btn-action-primary { 
            ...
            transition: background-color 0.2s ease, transform 0.1s ease; /* Transformación rápida para el clic */
        ...
        .btn-action-primary:active { 
            /* En lugar de volver a translateY(0) y desaparecer, hacemos que se encoja un poquito */
        ...
        .hover-up:hover { transform: translateY(-2px); border-color: #bae6fd !important; }
    </style>
        ...
        document.addEventListener('DOMContentLoaded', function() {
                ...
                new Chart(ctx, {
                    ...
                    data: {
                        ...
                        datasets: [{
                            ...
                            data: chartData,
                            backgroundColor: 'rgba(2, 132, 199, 0.7)', /* Azul translúcido */
                            borderColor: 'rgba(2, 132, 199, 1)', /* Azul sólido */
                            borderWidth: 1,
                            borderRadius: 6,
                            barPercentage: 0.6
                        }]
            ...
            if (modalInputCantidad && modalContenedorArchivos) {
                modalInputCantidad.addEventListener('input', function() {
                    ...
                    modalContenedorArchivos.innerHTML = ''; 
