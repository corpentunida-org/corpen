            ...
            <div class="table-responsive">
                <table class="table table-hover align-middle mb-0" style="border-collapse: separate; border-spacing: 0 12px;">
                    <thead class="text-muted small text-uppercase bg-light">
                        <tr>
                            <th class="ps-5 border-0 py-3">No. Radicado</th>
                            <th class="border-0 py-3">Fecha</th>
                            <th class="border-0 py-3">Estado Actual</th>
                            <th class="border-0 py-3 text-end pe-5">Líneas Asociadas</th>
                        </tr>
                    </thead>
                    <tbody class="px-3">
                        @forelse($operaciones as $operacion)
                            <tr class="bg-white">
                                <td class="ps-5">
                                    <div class="badge-radicado fw-bold">
                                ...
                                <td class="text-end pe-5">
                                    <span class="badge bg-light text-dark border rounded-circle" style="padding: 0.6rem 0.8rem; font-size: 0.9rem;">
