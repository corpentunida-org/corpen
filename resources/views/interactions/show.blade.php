        ...
        <div class="row g-4">
            ...
            <div class="col-lg-4">
                ...
                @if($interaction->comprobantes->isNotEmpty())
                    <div class="glass-card p-4 text-center mt-4" style="border-top: 4px solid var(--p-green); border-radius: 12px;">
                        ...
                        @foreach($interaction->comprobantes as $comprobante)
                            <div class="bg-light p-4 rounded-3 mb-4 text-start border border-success border-opacity-25 shadow-sm position-relative overflow-hidden">
                                ...
                                {{-- Bloque del Banco --}}
                                <div class="d-flex align-items-center mb-4 p-3 bg-white rounded border border-gray-200 shadow-xs">
                                    <div class="d-flex align-items-center justify-content-center bg-light-primary text-primary rounded-circle me-3" style="width: 35px; height: 35px;">
                                        <i class="fas fa-university fs-6"></i>
                                    </div>
                                    <div class="d-flex flex-column">
                                        <span class="text-muted fw-bold fs-9 text-uppercase ls-1">Banco Destino</span>
                                        <span class="text-dark fw-bolder fs-7 text-truncate" style="max-width: 200px;">
                                ...
                                <div class="row g-2 mb-4">
                                    <div class="col-4">
                                        <div class="border border-dashed border-gray-300 rounded p-2 text-center bg-white h-100 d-flex flex-column justify-content-center">
                                            <span class="text-muted fs-9 fw-bold d-block text-uppercase mb-1">Cuota</span>
                                            <span class="text-dark fw-bolder fs-7">{{ $comprobante->numero_cuota ?? '--' }}</span>
                                        </div>
                                    </div>
                                    <div class="col-4">
                                        <div class="border border-dashed border-gray-300 rounded p-2 text-center bg-white h-100 d-flex flex-column justify-content-center">
                                            <span class="text-muted fs-9 fw-bold d-block text-uppercase mb-1">PR</span>
                                            <span class="text-dark fw-bolder fs-7">{{ $comprobante->pr ?? '--' }}</span>
                                        </div>
                                    </div>
                                    <div class="col-4">
                                        <div class="border border-dashed border-gray-300 rounded p-2 text-center bg-white h-100 d-flex flex-column justify-content-center">
                                            <span class="text-muted fs-9 fw-bold d-block text-uppercase mb-1">CCO</span>
                                            <span class="text-dark fw-bolder fs-7">{{ $comprobante->cco ?? '--' }}</span>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="d-grid mt-2">
                                    @if($comprobante->ruta_archivo)
                                        <a href="{{ $comprobante->url_archivo }}" target="_blank" class="btn btn-success border-0 py-3 rounded-pill shadow-sm fw-bolder fs-7 transition-all">
                                            <i class="fas fa-external-link-alt me-2"></i>Ver Recibo Completo
                                        </a>
                                    @else
                                        <button disabled class="btn btn-light text-muted border-0 py-3 rounded-pill fw-bolder fs-7">
