<x-base-layout>
    <div class="app-container py-5">
        ...
        <div class="bg-white shadow-sm border border-gray-300 mx-3 d-flex flex-column"
                    ...
                    <tbody>
                        @forelse($comprobantes as $index => $comprobante)
                            <tr>
                                ...
                                <td class="text-center font-monospace text-muted">{{ $comprobante->numero_cuota ?? '---' }}
                                </td>
                                ...
                                <td class="text-center">
                                    <span
                                        class="{{ $comprobante->tipo_pago ? 'badge text-bg-secondary' : '' }} fs-10 text-uppercase">
                                ...
                                <td class="text-center">
                                    <div class="d-flex justify-content-center gap-2">
                                        <a href="{{ route('cartera.comprobantes.show', $comprobante->id) }}"
                                            class="text-gray-600"><i class="fas fa-eye fs-9"></i></a>
                                        <form action="{{ route('cartera.comprobantes.destroy', $comprobante->id) }}"
                                            method="POST" class="d-inline delete-form">
                                            @csrf @method('DELETE')
                                            <button type="button"
                                                class="border-0 bg-transparent p-0 text-gray-400 btn-delete"><i
                                                    class="fas fa-trash-alt fs-9"></i></button>
                                        </form>
                                    </div>
                                </td>
                            </tr>
            ...
            <div
                class="bg-white border-top border-gray-300 p-2 d-flex justify-content-between align-items-center fs-9 text-muted">
                <div class="d-flex align-items-center">
