<x-base-layout>
    <style>
        ...
        /* NUEVOS ESTILOS PARA LAS PESTAÑAS (Filtros Rápidos) */
        ...
        .st-disp { background: #dcfce7; color: #166534; } /* Disponible */
        .st-asig { background: #fef3c7; color: #92400e; } /* Asignado */
        .st-mant { background: #e0f2fe; color: #075985; } /* Mantenimiento/Otro */
    </style>
                    ...
                    <div class="list-container" id="activosList">
                        @forelse($activosDisponibles as $activo)
                            @php
                                ...
                                // Esta variable nos sirve para el filtro JS de las pestañas
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // 3. LÓGICA DE LAS PESTAÑAS (Filtros Rápidos)
            ...
            // FUNCIÓN MAESTRA QUE APLICA TODOS LOS FILTROS (Bodega + Pestaña + Texto)
            ...
            // 5. SELECCIONAR TODOS LOS VISIBLES
