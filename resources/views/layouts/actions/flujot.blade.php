<li class="nxl-item nxl-hasmenu {{ request()->routeIs('flujo.*') ? 'active' : '' }}">
    ...
    <ul class="nxl-submenu">
        {{-- TABLERO --}}
        @candirect('flujot.dashboard.index')
        ...
        <li class="nxl-item {{ request()->routeIs('flujo.workflows.create') ? 'active' : '' }}">
            <a class="nxl-link" href="{{ route('flujo.workflows.create') }}"
                style="color: var(--primary-indigo); font-weight: 600;">
        ...
        <li class="nxl-item {{ request()->routeIs('flujo.tasks.create') ? 'active' : '' }}">
            <a class="nxl-link" href="{{ route('flujo.tasks.create') }}"
                style="color: var(--primary-indigo); font-weight: 600;">
