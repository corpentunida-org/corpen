...
/**
 * geo_paises (creada por GeoColombiaSeeder) solo tiene 1 fila (Colombia) — no sirve como
 * catálogo de países. Esta tabla nueva trae el listado completo (ISO 3166-1 alpha-2).
 */
return new class extends Migration
{
    public function up(): void
    {
        ...
        $paises = [
            ...
            ['AZ', 'Azerbaiyán'], ['BS', 'Bahamas'], ['BD', 'Bangladés'], ['BB', 'Barbados'],
            ['BH', 'Baréin'], ['BE', 'Bélgica'], ['BZ', 'Belice'], ['BJ', 'Benín'],
            ['BY', 'Bielorrusia'], ['MM', 'Birmania (Myanmar)'], ['BO', 'Bolivia'],
            ...
            ['EE', 'Estonia'], ['ET', 'Etiopía'], ['PH', 'Filipinas'], ['FI', 'Finlandia'],
            ['FJ', 'Fiyi'], ['FR', 'Francia'], ['GA', 'Gabón'], ['GM', 'Gambia'], ['GE', 'Georgia'],
            ['GH', 'Ghana'], ['GD', 'Granada'], ['GR', 'Grecia'], ['GT', 'Guatemala'],
            ['GY', 'Guyana'], ['GN', 'Guinea'], ['GQ', 'Guinea Ecuatorial'], ['GW', 'Guinea-Bisáu'],
            ['HT', 'Haití'], ['HN', 'Honduras'], ['HU', 'Hungría'], ['IN', 'India'],
            ['ID', 'Indonesia'], ['IQ', 'Irak'], ['IR', 'Irán'], ['IE', 'Irlanda'], ['IS', 'Islandia'],
            ['MH', 'Islas Marshall'], ['SB', 'Islas Salomón'], ['IL', 'Israel'], ['IT', 'Italia'],
            ['JM', 'Jamaica'], ['JP', 'Japón'], ['JO', 'Jordania'], ['KZ', 'Kazajistán'],
            ['KE', 'Kenia'], ['KG', 'Kirguistán'], ['KI', 'Kiribati'], ['KW', 'Kuwait'],
            ['LA', 'Laos'], ['LS', 'Lesoto'], ['LV', 'Letonia'], ['LB', 'Líbano'], ['LR', 'Liberia'],
            ['LY', 'Libia'], ['LI', 'Liechtenstein'], ['LT', 'Lituania'], ['LU', 'Luxemburgo'],
            ['MK', 'Macedonia del Norte'], ['MG', 'Madagascar'], ['MY', 'Malasia'], ['MW', 'Malaui'],
            ['MV', 'Maldivas'], ['ML', 'Malí'], ['MT', 'Malta'], ['MA', 'Marruecos'],
            ['MU', 'Mauricio'], ['MR', 'Mauritania'], ['MX', 'México'], ['FM', 'Micronesia'],
            ['MD', 'Moldavia'], ['MC', 'Mónaco'], ['MN', 'Mongolia'], ['ME', 'Montenegro'],
            ['MZ', 'Mozambique'], ['NA', 'Namibia'], ['NR', 'Nauru'], ['NP', 'Nepal'],
            ['NI', 'Nicaragua'], ['NE', 'Níger'], ['NG', 'Nigeria'], ['NO', 'Noruega'],
            ['NZ', 'Nueva Zelanda'], ['OM', 'Omán'], ['NL', 'Países Bajos'], ['PK', 'Pakistán'],
            ['PW', 'Palaos'], ['PA', 'Panamá'], ['PG', 'Papúa Nueva Guinea'], ['PY', 'Paraguay'],
            ['PE', 'Perú'], ['PL', 'Polonia'], ['PT', 'Portugal'], ['GB', 'Reino Unido'],
            ['CF', 'República Centroafricana'], ['CZ', 'República Checa'],
            ['CD', 'República Democrática del Congo'], ['CG', 'República del Congo'],
            ['DO', 'República Dominicana'], ['RW', 'Ruanda'], ['RO', 'Rumanía'], ['RU', 'Rusia'],
            ['WS', 'Samoa'], ['KN', 'San Cristóbal y Nieves'], ['SM', 'San Marino'],
            ['VC', 'San Vicente y las Granadinas'], ['LC', 'Santa Lucía'],
            ['ST', 'Santo Tomé y Príncipe'], ['SN', 'Senegal'], ['RS', 'Serbia'],
            ['SC', 'Seychelles'], ['SL', 'Sierra Leona'], ['SG', 'Singapur'], ['SY', 'Siria'],
            ['SO', 'Somalia'], ['LK', 'Sri Lanka'], ['SZ', 'Suazilandia (Esuatini)'],
            ['ZA', 'Sudáfrica'], ['SD', 'Sudán'], ['SS', 'Sudán del Sur'], ['SE', 'Suecia'],
            ['CH', 'Suiza'], ['SR', 'Surinam'], ['TH', 'Tailandia'], ['TZ', 'Tanzania'],
            ...
            ['VE', 'Venezuela'], ['VN', 'Vietnam'], ['YE', 'Yemen'], ['DJ', 'Yibuti'],
            ['ZM', 'Zambia'], ['ZW', 'Zimbabue'],
        ];

        $now = now();
        DB::table('paises')->insert(array_map(
            fn($p) => ['codigo_iso' => $p[0], 'nombre' => $p[1], 'created_at' => $now, 'updated_at' => $now],
            $paises
        ));
    }
