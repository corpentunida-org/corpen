...
return new class extends Migration
{
    ...
    {
        Schema::create('car_sia_tipos_evento', function (Blueprint $table) {
            ...
            // Llave foránea a los tipos de evento (NOT NULL)
            $table->foreignId('id_car_sia_tipos')
                  ->constrained('car_sia_tipos');
    ...
    {
        Schema::dropIfExists('car_sia_tipos_evento');
    }
};
